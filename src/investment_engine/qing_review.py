...
STAGE_MAP: dict[str, str | None] = {
    ...
    "退潮期（调整期）": "调整",  # 8-24：退潮+调整复合定性，归调整桶（同退潮期口径）
    "缩量冰点/等右侧确认": "调整",  # 8-25：冰点无恐慌杀跌、等右侧，同冰点期口径
    "弱修复/磨底": "调整",  # 8-26：复合标签取当前状态「磨底」（同磨底期口径；当日真值震荡，如实记 miss）
    "调整期/缩量冰点磨底": "调整",  # 9-03：缩量冰点磨底+等右侧确认，同「缩量冰点/等右侧确认」口径
    "调整期/恐慌杀跌": "恐慌",
    "调整期/恐慌冰点": "恐慌",
    "未判断": None,
}
