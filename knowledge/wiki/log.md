...
## 2026-06-01 | qing-learning ingest | 6-01早盘：调整周期第13天，AI与PCB共振观察

- 处理 raw：`sources/raw/财经/早盘：26-06-01：调整周期第13天，AI与PCB共振观察.md`
- 新增 claim 文件：
  - `knowledge/claims/claim-20260601-001.yaml`：上证指数日线顶部结构第13天4032点趋势破位参考位、中小盘风格月初有望企稳反弹、今日重点关注AI主线与PCB板块、泓淋电力竞价表现是科技股情绪风向标、跌停家数控制在10家以内是企稳信号、新热点英伟达AI PC端侧与MiniMax、早盘操作预案先观察再动手、6月解禁压力+大型IPO虹吸效应
- 新增 wiki：
  - `knowledge/wiki/每日复盘/2026-06-01.md` — 早盘完整记录：指数状态、板块前瞻、关键观察点、操作预案、风险提示
- 更新 claims/index.md：新增 claim-20260601-001.yaml 的8条claims索引
- 更新 wiki/index.md：新增每日复盘/2026-06-01.md 索引
- 核心学习：
  - 上证指数日线顶部结构第13天是重要时间窗口，4032点为趋势破位参考位，有效跌破则调整空间打开。
  - 科创50 120分钟顶部结构第3天+主跌阶段，早盘惯性下探概率大，但中期不具备持续大跌基础。
  - 熬过月初调整后中小盘有望企稳反弹，结构性赚钱效应概率较高。
  - 今日板块关注AI主线（共振反弹=转强信号）和PCB（周末利好），但防御与科技跷跷板效应可能延后科技股反弹。
  - 泓淋电力竞价表现是科技股情绪风向标，类似4月23日安诺其案例。
  - 跌停家数≤10家且连续两日是中小盘企稳反弹明确信号（5月14日以来仅3天个位数跌停）。
  - 操作纪律：先观察再动手，不急于抄底；积极条件同时满足才小仓位参与，弱势延续则继续观望。
  - 6月风险：解禁压力+长鑫存储等大型IPO虹吸+一九分化格局。
- Framework 更新：未更新。本次为单日早盘策略，已有"仓位管理、交易纪律、情绪判断"框架可覆盖。
- 总纲更新：未更新。本次为单日盘面案例和短期策略，尚未满足总纲级沉淀条件。

## 2026-05-31 | qing-learning ingest | 5-31盘后复盘：科技震荡消化拥挤，被动元件全面进入周期上行

- 处理 raw：`sources/raw/财经/复盘：26-05-31：科技震荡消化拥挤，被动元件全面进入周期上行.md`
- 新增 claim 文件：
  - `knowledge/claims/claim-20260531-002.yaml`：科技主线震荡消化拥挤不切换、MLCC全面进入周期上行（本质是外溢承接而非类存储大紧缺）、MLCC涨价结构与供需格局、AI服务器MLCC用量持续上行、PCB价值量斜率最陡（VR200+233%）、煤炭安监+迎峰度夏、安赛蜜三轮涨价87.5%、巨化超纯PFA突破+HFCs超长景气、城市更新"十五五"13万亿、长鑫存储上市科创板资金分流风险、算电协同平台上线。
- 新增 wiki：
  - `knowledge/wiki/市场分析/MLCC与被动元件.md` — MLCC周期上行全景：行情本质纠偏、AI用量数据、涨价结构、供给端分析、技术格局、竞争格局、最新边际变化、连接器、江海股份、三条受益逻辑
- 更新 wiki：
  - `knowledge/wiki/每日复盘/2026-05-31.md` — 追加盘后深度复盘章节（市场大势、被动元件、顺周期线索、风险提示）
- 更新 claims/index.md：新增 claim-20260531-002.yaml 的11条claims索引
- 核心学习：
  - 科技主线震荡是消化拥挤而非切换，存量环境下支线不会因主线退潮而自动受益，低位方向缺增量资金时是反弹非反转。
  - MLCC行情需要纠偏：不是"类存储"大紧缺周期，而是海外产能结构性转移（低容→高容）造成的外溢承接，A股偏海外映射，量的改善强于价的改善。
  - MLCC核心数据：高容涨30%/常规5%、中低容交期延长至12周+、紧缺延续至2026年底、AI占MLCC总需求仅8%（年末15%）。
  - PCB价值量斜率最陡：VR200单机柜PCB价值+233%，M9+mSAP+CoWoP推动向半导体级跃迁，头部壁垒提升。
  - 长鑫存储6月下旬-7月初上市，估值2.6万亿起步/3万亿打底，是科创板历史级IPO，对半导体/科创板块形成显著资金分流压力，需做好止盈安全垫。
  - 顺周期线索可作低吸补充：煤炭（安监+旺季）、安赛蜜（三寡头格局）、巨化（PFA突破+制冷剂超长景气）、城市更新（13万亿+专项债作资本金）。
- Framework 更新：未更新。本次为盘后产业链深度复盘，属于专题认知层内容，跨阶段 durable rule 尚需验证。
- 总纲更新：未更新。MLCC周期框架已作为专题 wiki 沉淀，待更多市场阶段验证后再考虑是否纳入总纲。

## 2026-05-31 | qing-learning ingest | 5-31周复盘：美股高盛调整、原油黄金、A股操作策略

- 处理 raw：`sources/raw/财经/周复盘：26-05-31：周度市场复盘-美股高盛标普500调整研判，原油黄金走势分析与A股操作策略.md`
- 新增 claim 文件：
  - `knowledge/claims/claim-20260531-001.yaml`：高盛标普500上调8000点但增长空间有限、美股暴跌保护小组频繁干预、美股投资偏好从半导体转向软件/电力、原油目标80黄金目标4200、国家队减持4500亿盈利留存为救市弹药、上证30分钟底部4055支撑、科创50 120分钟双顶、加杠杆低频重仓策略、AI软件股轮动机会、消费老妖股机会与游资风险。
- 新增 wiki：
  - `knowledge/wiki/每日复盘/2026-05-31.md` — 周复盘完整记录：美股高盛调整、暴跌保护小组、原油黄金目标、国家队减持解读、上证/科创50技术判断、板块机会与风险
- 更新 wiki：
  - `knowledge/wiki/市场分析/关键点位.md` — 追加4055点30分钟底部支撑、科创50 120分钟双顶结构
  - `knowledge/wiki/投资方法论/交易纪律.md` — 追加"加杠杆投资者的低频重仓纪律"完整章节
- 更新 claims/index.md：新增 claim-20260531-001.yaml 的10条claims索引
- 核心学习：
  - 高盛上调标普500至8000点但强调"增长空间有限"，牛市终结条件部分降临，是风险提示而非无条件看多。
  - 美股暴跌保护小组6月干预会更频繁，托市越久后续回调越大，对A股科技板块有传导风险。
  - 美股资金偏好从半导体切换至软件和电力基础设施，A股AI软件股和电力设备可能受益轮动。
  - 国家队减持4500亿被市场误读为利空，实际是隐含利好（盈利留存为救市弹药、6月减持完毕后托底能力更强）。
  - 上证4055是30分钟底部支撑，不跌破可看周一反弹，但反弹属小级别，周二不继续走强则卖出。
  - 科创50 120分钟双顶对应4-6个交易日调整，较深调整后存在短期介入机会。
  - 加杠杆投资者反常识纪律：分仓不适用（收益无法覆盖资金成本），唯一生存策略是低频重仓，成功翻身必须及时去杠杆。
  - 消费老妖股未来两周有表现空间，但游资借用量化/机构席位隐身炒作，普通投资者不宜参与纯情绪标的。
- Framework 更新：未更新。本次为周度复盘，技术判断和策略建议具有短期时效性，跨阶段 durable rule 尚需验证。
- 总纲更新：未更新。"加杠杆低频重仓"已作为交易纪律记录，待更多案例验证后再考虑纳入总纲。

## 2026-05-30 | qing-learning ingest | 5-30宏观视频：分化时代下的房地产、消费和港股

- 处理 raw：`sources/raw/财经/视频：26-05-30：分化时代下的房地产、消费和港股.md`
- 新增 claim 文件：
  - `knowledge/claims/claim-20260530-001.yaml`：全球K型分化的三股核心力量、AI红利分配不均、美联储截尾平均PCE为降息铺台阶、美股盈利集中度过高、港股核心矛盾是盈利预期、港股解禁高峰与配置窗口、房地产增量时代结束、城市更新利好方向、消费K型分化、商品消费四大方向与服务消费五大趋势、AI时代财富向头部集中。
- 新增 wiki：
  - `knowledge/wiki/宏观政策/全球经济K型分化.md` — K型分化定义、三股驱动力量（AI/保护主义/地缘政治）、美国经济与美联储政策、美股矛盾与风险
  - `knowledge/wiki/市场分析/房地产城市更新.md` — 房地产K型分化现状、城市更新范式转变、投资方向与受益板块
  - `knowledge/wiki/市场分析/消费新结构.md` — 消费板块整体格局、商品消费四大方向、服务消费五大趋势、细分赛道
- 更新 wiki：
  - `knowledge/wiki/宏观政策/港股通投资机会.md` — 追加港股资金结构（南向/险资/外资）、反常表现分析、6-7月解禁风险与8-9月配置窗口
- 更新 claims/index.md：新增 claim-20260530-001.yaml 的11条claims索引
- 核心学习：
  - K型分化渗透到国家、行业、企业、个人所有层面，传统整体分析失效，必须分层看待。
  - AI准备度四要素（基础设施+创新系统+人才+政策）决定国家/企业的AI受益程度。
  - 美联储截尾平均PCE是统计口径技术调整，打破"通胀高企不会降息"共识，下半年流动性拐点概率较高。
  - 美股三重矛盾：盈利集中度极高、AI资本开支与自由现金流背离、实体经济指标与股市表现背离。
  - 港股核心矛盾不是流动性而是盈利预期，高股息有险资OCI+免税+南向资金的长期支撑。
  - 房地产从增量征地转向存量更新，受益方向从开发商转向建材家居、家装、智能家居、适老化改造和存量物业。
  - 消费投资需区分口径（社零≠全部消费），商品消费看四条线，服务消费看五趋势。
  - 对普通人而言，稳定工作提供持续现金流是最佳策略，持有现金、长期活在市场里就能吃到科技变革红利。
- Framework 更新：未更新。本次为宏观经济分析视频，属于认知层内容，跨阶段 durable rule 尚需更多市场阶段验证。
- 总纲更新：未更新。原因是本次为宏观专题分析，部分观点（如K型分化框架、AI准备度）具有长期价值，但尚未经过多市场阶段验证，暂不提升为总纲级稳定框架。"AI时代财富向头部集中，稳定工作更重要"已作为方法论原则记录，待后续多篇raw验证后再考虑纳入总纲。

## 2026-05-28 | qing-learning ingest | 5-28盘中动态与尾盘策略

- 处理 raw：
  - `sources/raw/财经/动态：26-05-28：4050支撑确认与情绪拐点.md`
  - `sources/raw/财经/动态：26-05-28：产业逻辑视频计划与观察标的.md`
  - `sources/raw/财经/动态：26-05-28：大级别调整未完，等美股黄金坑.md`
  - `sources/raw/财经/动态：26-05-28：尾盘仓位建议与明日策略.md`
- 新增 claim 文件：
  - `knowledge/claims/claim-20260528-003.yaml`：4050第一波支撑有效性确认、情绪拐点+30分钟底部结构的反弹定性、美股风险窗口期的操作克制、大级别调整未完等美股黄金坑、霍尔木兹海峡可控小摩擦、情绪拐点日仓位管理（空仓上5成/满仓降仓）、明日调整是更好确定点、规避半导体和消费、行情平淡期加大研究储备、观察标的提示（诚意药业/海王生物/东方海洋）。
- 更新 wiki：
  - `knowledge/wiki/每日复盘/2026-05-28.md` — 新增尾盘动态章节，完整记录日内判断链条（09:12→10:40→12:16→13:16→13:44→14:41）
- 核心学习：
  - 4050预设支撑基本确认，实际低点4055仅差5点，因外围地缘风险下探但未破位。
  - 当前拉升属于情绪拐点+30分钟底部结构驱动，但周期不大，属于小级别反弹而非大级别反转。
  - 大级别调整尚未结束，关键变量是今晚美股表现；若美股跳水，A股黄金坑时刻到来。
  - 霍尔木兹海峡事件属可控小摩擦，伊朗回应克制（3-4架无人机象征性攻击），未造成实质损失。
  - 情绪拐点日仓位管理双向建议：空仓者上5成（不宜过度悲观），满仓者降仓（外盘风险留空间）。
  - 明日可能会调整，但调整是更好确定点——可验证今日低点有效性，不创新低则底部确认。
  - 当前应规避半导体（受美股科技股波动影响）和消费（过渡性质确认）。
  - 行情平淡期减少交易，加大产业研究储备（博主计划更新约10个产业逻辑视频）。
- Framework 更新：未更新。本次主要是5月28日单日盘中判断和操作策略，已有"仓位管理、交易纪律、技术分析"框架可覆盖。
- 总纲更新：未更新。原因是本次为单日盘面案例和短期策略，尚未满足总纲级沉淀条件（跨多篇raw验证或改变核心框架）。

## 2026-05-29 | qing-learning ingest | 5-29午盘：高低切换剧本，买阴卖阳等共振

- 处理 raw：
  - `sources/raw/财经/午盘：26-05-29：高低切换剧本，买阴卖阳等共振.md`
- 新增 claim 文件：
  - `knowledge/claims/claim-20260529-002.yaml`：今日上午定性为高低切换剧本而非下跌新周期、AI科技获利回吐而非趋势破坏、消费超跌方向的先涨后跌风险、买阴卖阳策略与低吸做T、全A下跌结构需强势阳线共振消除。
- 更新 wiki：
  - `knowledge/wiki/每日复盘/2026-05-29.md` — 新增午盘动态章节，完整记录高低切换判断、板块分析和操作策略
- 更新 claims/index.md：
  - 新增 claim-20260529-002.yaml 的5条claims索引
- 核心学习：
  - 今日上午三大指数走低、全A回落、七成个股飘绿，本质是上涨乏力后的强轮动，而非高位杀跌或新下跌周期开启。
  - AI科技内部分歧明显但仍有支撑，真正调整较多的是昨日大涨且强度不高的品种（长电、华天、鹏鼎、生益、中芯），属于正常获利回吐而非趋势破坏。
  - 白酒、地产、金融等低位超跌方向是纯低位反弹，暂看不出持续性；一旦消费成为下一周期主线，反而要警惕行情进入尾声。
  - 市场难度增大时应谨慎追高，采用买阴卖阳策略；大盘止跌企稳位置低吸一波，涨起来再出掉，是很好的做T节点。
  - 全A的下跌结构仍需强势阳线共振才能消除，当前不必过度恐慌，重心仍在科技，觉得太难则继续等待强共振出现。
- Framework 更新：未更新。本次主要是5月29日单日午盘判断和操作策略，已有"交易纪律、仓位管理、主线判断"框架可覆盖。
- 总纲更新：未更新。原因是本次为单日盘面案例，尚未满足总纲级沉淀条件（跨多篇raw验证或改变核心框架）。

## 2026-05-29 | qing-learning ingest | 5-29 UP评论：跟指数共振择股标准

- 处理 raw：
  - `sources/raw/财经/动态：26-05-29：注意仓位评论-跟指数动的票.md`
- 新增 claim 文件：
  - `knowledge/claims/claim-20260529-001.yaml`：择股标准——跟随指数共振、排除标准——未跟指数动的票不碰、赚钱效应确认。
- 更新 wiki：
  - `knowledge/wiki/投资方法论/主线判断.md` — 新增"择股标准：跟随指数共振"、"排除标准：未跟指数动的票不碰"
  - `knowledge/wiki/投资方法论/交易纪律.md` — 新增"排除标准：未跟指数动的票不碰"
- 核心学习：
  - 情绪拐点确认后，选股标准是"今天下午跟着指数涨的都可以"，即与指数同步共振的标的才是首选。
  - 不跟指数涨=资金不认可=缺乏主线逻辑，情绪修复日非共振方向被边缘化，短期回避。
  - 整体赚钱效应已经起来，市场进入可操作窗口，但可操作窗口不等于主升窗口，仍需控制仓位。
- Framework 更新：未更新。本次为单日择股标准评论，已有"主线判断、交易纪律"框架可覆盖。
- 总纲更新：未更新。原因是本次为单日盘面择股技巧，尚未满足总纲级沉淀条件。

## 2026-05-29 | qing-learning ingest | 5-29动态：城市更新规划与房地产涨停提醒

- 处理 raw：
  - `sources/raw/财经/动态：26-05-29：城市更新十五五规划与房地产涨停提醒.md`
- 新增 claim 文件：
  - `knowledge/claims/claim-20260529-004.yaml`：房地产政策催化与短期事件驱动、政策利好不等于买入信号。
- 更新 wiki：
  - `knowledge/wiki/每日复盘/2026-05-29.md` — 新增城市更新规划章节，记录政策催化与"不要追"提醒
  - `knowledge/wiki/投资方法论/交易纪律.md` — 新增"政策利好不等于买入信号"纪律
  - `knowledge/wiki/投资方法论/主线判断.md` — 新增相关claim引用
- 更新 claims/index.md：
  - 新增 claim-20260529-004.yaml 的2条claims索引
- 核心学习：
  - 城市更新"十五五"规划引发房地产涨停，但博主明确提示"不要追"，属于短期事件驱动而非主线方向。
  - 政策利好发布时需区分主线逻辑（长期产业格局改变）和短期事件驱动（情绪炒作），后者追涨风险高。
  - 房地产/消费属于过渡性质，与AI/半导体主线逻辑不符，后续视频会专门讲解但当前阶段不是系统性机会。
- Framework 更新：未更新。本次为政策催化案例，已有"交易纪律、主线判断"框架可覆盖。
- 总纲更新：未更新。原因是本次为单日政策事件分析，尚未满足总纲级沉淀条件。

## 2026-05-29 | qing-learning ingest | 5-29动态：大周期弱势，调整正常

- 处理 raw：
  - `sources/raw/财经/动态：26-05-29：大周期还是很弱，今天调整很正常.md`
- 新增 claim 文件：无（该动态为博主回应市场恐慌，属于观点确认而非新逻辑，已在前序claims中覆盖）
- 更新 wiki：
  - `knowledge/wiki/每日复盘/2026-05-29.md` — 新增14:26动态补充章节，记录博主对调整的定性
- 核心学习：
  - 博主回应市场恐慌：昨日已提示大周期弱势、仓位管理、早上做T、午盘下跌前说不好做就不做。
  - 行情正式宣告结束的说法是错的——调整是预期内的，关键是提前做好了仓位管理和应对预案。
  - 大级别调整还没结束（与5月28日判断一致），今天调整是预期内的不是意外。
- Framework 更新：未更新。本次为观点连续性确认，已有"仓位管理、交易纪律"框架可覆盖。
- 总纲更新：未更新。

## 2026-05-26 | qing-learning ingest | 5-26午盘利通与盘后双核心复盘

- 处理 raw：
  - `sources/raw/财经/午盘补发：26-05-26：利通电子.md`
  - `sources/raw/财经/动态复盘：26-05-26：双核心分歧修复，PCB与韬定律反包观察.md`
- 新增 claim 文件：
  - `knowledge/claims/claim-20260526-024.yaml`：利通电子高位不健康是卖点不是买点、尾盘修复提前消耗次日普涨预期、科技回落是韬定律休整非证伪、PCB与韬定律双核心、情绪端先于指数确认、PCB跨代价值阶梯、韬定律分歧后主动修复、光模块设备扩产、国产算力节奏问题、新技术分支中期并行、防御与科技同步加强、制冷剂补库、AIDC电力设备、MLCC新周期。
- 新增 wiki：
  - `knowledge/wiki/市场分析/制冷剂与氟化工.md`
- 更新 wiki：
  ...
  - `knowledge/wiki/投资方法论/分歧中找机会.md`
  - `knowledge/wiki/投资方法论/仓位管理.md`
- 核心学习：
  - “准备抄底”有边界。高位走势不健康且存在压异动压力的利通电子，不属于分歧低吸对象；对已有利润仓更偏卖点和利润处理。
  - 5月26日尾盘科技快速修复提前消耗了部分5月27日普涨预期，次日不宜简单追高，但回落空间也可能因主线承接而有限。
  - 科技回落被盘后定性为韬定律节奏内休整，不是逻辑证伪；后续仍按主线回流和反包验证处理。
  - PCB与华为韬定律被收敛为本轮双核心：PCB看分歧后反包和Kyber价值阶梯，韬定律看长电科技/先进封装中军主动修复和3D堆叠扩散。
  - 调整结束不能只看指数回升，要看情绪端是否先于指数走强，例如是否出现4板以上高度龙头并形成板块联动。
  - 防御方向和科技同步加强可解释为资金两端铺仓；若后续防御强而主线回落，则要警惕资金从科技撤退。
- Framework 更新：未更新。双核心反包、分歧后主动修复、情绪端先于指数等内容已进入方法论 wiki；仍需更多交易日验证后再抽象为跨阶段 durable rule。
- 总纲更新：未更新。原因是本次主要是5月26日单日盘后确认和分支扩展，尚未改变总纲级周期/仓位框架。

## 2026-05-26 | qing-learning ingest | 5-26盘中动态：继续持股与准备抄底

- 处理 raw：
  - `sources/raw/财经/早盘动态补发：26-05-26：继续持股.md`
  - `sources/raw/财经/盘中动态补发：26-05-26：准备抄底.md`
- 新增 claim 文件：
  - `knowledge/claims/claim-20260526-020.yaml`：普涨后调整正常、半导体有承接即可继续持股、明日才是强弱决战点、11:05后半小时到一小时抄底窗口、抄底选择跌得多且自己看好的主线核心。
- 更新 wiki：
  - `knowledge/wiki/每日复盘/2026-05-26.md`
  - `knowledge/wiki/市场分析/半导体产业链.md`
  - `knowledge/wiki/投资方法论/交易纪律.md`
  ...
  - `knowledge/wiki/投资方法论/仓位管理.md`
- 核心学习：
  - 5月25日普涨后，5月26日上午调整可先按正常分歧处理，半导体只要不大跌且有承接，就不急于否定主线。
  - 5月26日是分歧承接验证日，5月27日才是半导体强弱确认的关键时间点。
  - 11:05后半小时到一小时是盘中低吸窗口，但只适用于跌幅充分、自己看好、属于近期主线核心且有承接的标的。
  - 跌停、贴近低点无拉回、后排弱分支和破位不能收回的票，不适用“准备抄底”。
- Framework 更新：未更新。本次是5月26日盘中执行案例，规则已经能被现有“分歧中找机会、盘中观点连续性、二次冰点低吸”框架覆盖。
- 总纲更新：未更新。原因是本次为单日盘中操作窗口，不改变总纲级框架。

## 2026-05-26 | qing-learning ingest | 5-26早盘补充：轻指数重个股，韬定律强度验证

- 处理 raw：`sources/raw/财经/早盘补充：26-05-26：轻指数重个股，韬定律主线与光缆铝土矿催化.md`。
- 新增 claim 文件：
  - `knowledge/claims/claim-20260526-011.yaml`：轻指数重个股、中际旭创防守锚、韬定律强度需强于Rubin链、一致高开不盲顶、Rubin链不追高等分歧、防御题材只作对冲、光缆集采、几内亚铝土矿管制、3万亿市场仍只做强度确认前排。
- 新增 wiki：
  - `knowledge/wiki/市场分析/光纤光缆.md`
  - `knowledge/wiki/市场分析/有色铝产业链.md`
- 更新 wiki：
  - `knowledge/wiki/每日复盘/2026-05-26.md`
  - `knowledge/wiki/市场分析/华为韬定律与3DIC.md`
...
- 核心学习：
  - 5月26日早盘策略从指数方向切换为轻指数重个股，主要看创业板指、科创50、中际旭创、3万亿量能和AI/半导体大盘趋势股承接。
  - 韬定律作为当日最强主线，必须通过10cm封单、20cm一进二、炸板回封、华大九天等正宗标的反包，并且强度明显优于Rubin链来验证。
  - Rubin链短期不证伪，但不追高，等待PCB/MLCC/超级电容核心分歧后的承接。
  - 电力、煤炭等防御方向只在科技不及预期时作对冲，不在科技核心承接良好时追涨切换。
  - 中国电信光缆集采强化光纤光缆景气周期观察；几内亚铝土矿管制属于资源品事件催化，需要外部核验和价格传导确认。
- Framework 更新：未更新。本次主要是单日早盘强度验证和分支交易预案，已有“不追一致、看承接、核心前排优先”的框架可覆盖。
- 总纲更新：未更新。原因是本次内容属于5月26日盘前案例和执行清单，尚未形成跨市场阶段的新总纲规则。
...
## 2026-05-25 | qing-learning ingest | 5月25日早盘动态补发与午盘补发

### 学习内容

- 处理 `sources/raw/财经/早盘动态补发：26-05-25：注意资金风格切换.md`
- 处理 `sources/raw/财经/午盘补发：26-05-25：保持思考.md`

### 抽取 Claims

| ID | 类型 | 主题 | 状态 |
|----|------|------|------|
| claim-20260525-013 | market-cycle | 资金风格切换与科技承接转弱 | active |
| claim-20260525-014 | operation | 老登股只适合提前埋伏 | active |
| claim-20260525-015 | sector-theme | 先进封装补制程短板 | active |
| claim-20260525-016 | methodology | 半导体与PCB同源技术催化 | active |
| claim-20260525-017 | risk | 突发利好后的次日承接验证 | active |
| claim-20260525-018 | technical-signal | 长鑫过会节点阶段性高点 | active |
| claim-20260525-019 | operation | 4170与仓位弹性 | active |

### 更新 Wiki

- 更新 `每日复盘/2026-05-25.md` — 新增早盘动态补发“注意资金风格切换”和午盘补发“保持思考”
- 更新 `市场分析/PCB与先进封装.md` — 新增技术催化后的承接验证与“先进封装补制程短板”
- 更新 `市场分析/半导体产业链.md` — 新增华为新技术打断调整节奏、长鑫过会阶段性高点
- 更新 `市场分析/长鑫存储产业链.md` — 新增过会是阶段高点、非长周期终点
- 更新 `市场分析/关键点位.md` — 新增4170作为盘中修复转强确认阈值
- 更新 `投资方法论/仓位管理.md` — 新增风格切换与突发利好后的仓位弹性
- 更新 `投资方法论/交易纪律.md` — 新增风格切换与突发利好过滤
- 更新 `投资方法论/主线判断.md` — 新增技术催化与风格切换的关系

### Framework 更新

- 未更新。本次属于5月25日盘中节奏修正和单日交易案例，主要沉淀到 wiki 与方法论页面；已有 framework 中的“不追一致、看承接、事件节点仓位管理”规则可覆盖。

### 总纲更新

- 未更新。原因是本次观点仍属于单日盘中案例和既有规则的应用，不改变博主方法论总纲的核心框架。

### 核心学习

- 科技主线不会一下子全部撤出，但科技承接转弱、老登股补涨时，应从进攻切换到保护利润。
- 老登股适合提前埋伏，不适合补涨后追高。
- 半导体上涨与周五PCB上涨同属技术催化打断调整节奏，但次日承接比当日加速更关键。
- 华为逻辑折叠技术被UP标注为“先进封装补制程短板”，可作为中期产业叙事，但短期仍需承接和验证。
- 长鑫过会大概率是阶段性高点，但未正式上市前不应视作长周期高点。
- 大盘未稳稳站上4170前，仓位管理比方向押注更重要。
...
## 2026-05-27 | qing-learning ingest | 5月27日早盘-指数调整无方向，华为韬不及预期

### 学习内容

- 处理 `sources/raw/财经/早盘：26-05-27：指数调整无方向，华为韬不及预期，等缩量等情绪回暖.md`

### 抽取 Claims

| ID | 类型 | 主题 | 状态 |
|----|------|------|------|
| claim-20260527-001-a | market-cycle | 指数短期调整无方向，放量滞涨 | active |
| claim-20260527-001-b | market-cycle | 大普微停牌是情绪转折点 | active |
| claim-20260527-001-c | macro | 地缘局势协议预期未兑现引发避险 | active |
| claim-20260527-001-d | operation | 等缩量或突破、等情绪回暖、等利好落地 | active |
| claim-20260527-001-e | sector-theme | 半导体大部分大分歧，调整概率偏大 | active |
| claim-20260527-001-f | sector-theme | AI趋势股箱体震荡，回落20%以内 | active |
| claim-20260527-001-g | sector-theme | 华为韬1不及预期，完全没匹配高规格叙事 | active |
| claim-20260527-001-h | sector-theme | AI资金应聚焦头尾两端：明牌标的与新方向 | active |
| claim-20260527-001-i | market-cycle | 一九行情靠AI带动赚钱效应 | active |
| claim-20260527-001-j | sector-theme | 人形机器人：宇树科技6月1日首发审议 | active |
| claim-20260527-001-k | sector-theme | 玻璃基板：英特尔/京东方+康宁合作 | active |
| claim-20260527-001-l | macro | 钨金属：2026年全球供需缺口1.85万吨 | active |
| claim-20260527-001-m | sector-theme | 存储芯片：美光涨19.29%，LTA锁定30%DDR | active |
| claim-20260527-001-n | sector-theme | 商业航天：SpaceX上市计划提振 | active |

### 矛盾链接更新

| Claim A | 关系 | Claim B | 类型 |
|---------|------|---------|------|
| claim-20260519-001-d（存储芯片是新分支，关注承接力） | contradicted by | claim-20260527-001-g（华为韬1不及预期） | cycle-shift |
| claim-20260519-003-e（卖半导体老题材，买存储芯片新分支） | superseded by | claim-20260527-001-d（等缩量等情绪回暖） | cycle-shift |

### 核心结论

1. **调整尚未结束**：指数暂无明确方向，量能未缩至2.5-2.6万亿，这几天放量滞涨
2. **情绪退潮蔓延**：大普微停牌是转折点，赚钱效应从短线→连板→趋势票传导垮塌
3. **华为韬1证伪**：高规格叙事未得到资金认可，10cm封单不足，20cm无一进二，中芯国际被闷杀
4. **半导体内部分化**：存储/封测/功率器件相对抗跌，其他方向大分歧
5. **AI处于正常调整**：趋势股箱体震荡，回落20%以内，需耐心等待回归
6. **操作策略**：等缩量/突破、等情绪回暖、等利好落地；已关注方向除德和卓外以做T应对
7. **一九行情特征**：低位板块难起，要靠AI这种资金介入深的方向带动赚钱效应
8. **题材资讯**：
   - 人形机器人产业化进入1-10阶段，宇树科技6月1日首发审议
   - 玻璃基板受英特尔/京东方+康宁催化
   - 钨金属全球供需缺口1.85万吨
   - 存储芯片：美光涨19.29%，LTA锁定30%DDR产能
   - 商业航天：SpaceX上市计划提振

### 更新 Wiki

- 新建 `每日复盘/2026-05-27.md`
- 更新 `市场分析/半导体产业链.md` — 新增5月27日"资金不想突破，调整周期延长"、机构资金撤退有节奏、半导体内部资金切换
- 更新 `市场分析/AI电源与超级电容.md` — 新增SST/功率器件完整产业链、800V架构、SiC/GaN标的分层、英伟达平台电源价值量对比
- 更新 `投资方法论/交易纪律.md` — 新增"发酵日不追"纪律

### 核心学习

- 5月27日早盘对半导体判断进行重大修正：从"韬定律节奏内休整"修正为"资金不想突破，调整周期延长"
- 半导体资金是机构资金（非游资），撤退有节奏，可通过盘口学习大资金撤退手法
- 半导体内部出现资金切换：卖老题材，买存储芯片新分支
- 华为韬1不及预期，完全没匹配高规格叙事，10cm封单不足、20cm无一进二
- 指数调整无方向，需等缩量/突破、等情绪回暖、等利好落地
- SST/功率器件是AI电源链新扩展方向，但5月27日已发酵，不应追高
- 英伟达Vera Rubin CPX版电源价值量较GB200增长超10倍，配电环节价值量大幅提升
- 功率器件逻辑类似MLCC（由电源拉动涨价），但MLCC逻辑更强（服务器需求体量更大）

### Framework 更新

- 未更新。本次内容主要是5月27日单日盘面修正和产业链梳理，已有"不追一致、看承接、发酵日不追"等框架可覆盖。

### 总纲更新

- 未更新。原因是本次为单日盘面判断修正和产业链专题补充，尚未满足总纲级稳定框架更新条件。

---

## 2026-05-27 | qing-learning ingest | 5月27日11点动态补充-学习大资金撤退手法

### 学习内容

- 处理 `sources/raw/财经/动态：26-05-27：11点动态补充-学习大资金撤退手法.md`

### 抽取 Claims

| ID | 类型 | 主题 | 状态 |
|----|------|------|------|
| claim-20260527-002-a | methodology | 半导体资金是机构资金，撤退有节奏 | active |
| claim-20260527-002-b | methodology | 通过盘口观察学习大资金撤退手法 | active |

### 更新 Wiki

- 更新 `每日复盘/2026-05-27.md` — 新增11点动态"机构资金撤退有节奏"
- 更新 `市场分析/半导体产业链.md` — 新增半导体资金性质判断

### 核心学习

- 半导体资金是机构资金，不是游资，撤退有节奏、波动温和
- 可通过盘口观察（挂单、成交、分时斜率、板块联动）学习大资金撤退手法
- 机构撤退不会瞬间崩盘，而是有过程的退潮

### Framework 更新

- 未更新。资金性质识别方法论需更多案例验证后再抽象为 durable rule。

### 总纲更新

- 未更新。原因是本次为单日盘口观察补充，尚未满足总纲级稳定框架更新条件。

---

## 2026-05-27 | qing-learning ingest | 5月27日11:08动态补充-电源SST功率器件产业链梳理

### 学习内容

- 处理 `sources/raw/财经/动态：26-05-27：11点08分补充-电源SST功率器件产业链梳理.md`

### 抽取 Claims

| ID | 类型 | 主题 | 状态 |
|----|------|------|------|
| claim-20260527-003-a | sector-theme | SST核心功率器件，2026年下半年需求紧张 | active |
| claim-20260527-003-b | sector-theme | 英伟达平台电源价值量大幅提升（Vera Rubin CPX超10倍） | active |
| claim-20260527-003-c | sector-theme | 电源走向800V，SiC与GaN最大受益 | active |
| claim-20260527-003-d | stock-view | 核心标的：扬杰、金盘、伊戈尔、江海股份 | active |
| claim-20260527-003-e | sector-theme | 功率器件逻辑类似MLCC但强度次 | active |
| claim-20260527-003-f | operation | 今天已发酵不要追，记时间节点 | active |
| claim-20260527-003-g | stock-view | GaN新洁能/SiC扬杰科技，英诺赛科入英伟达链 | active |
| claim-20260527-003-h | stock-view | 电容江海股份，材料东方钽业东阳光 | active |
| claim-20260527-003-i | stock-view | 二次电源新雷能 | active |

### 更新 Wiki

- 更新 `每日复盘/2026-05-27.md` — 新增11:08电源/SST/功率器件产业链梳理
- 更新 `市场分析/AI电源与超级电容.md` — 新增SST/功率器件完整产业链分层
- 更新 `投资方法论/交易纪律.md` — 新增"发酵日不追"纪律

### 核心学习

- SST核心是功率器件，预计2026年下半年HVDC与机柜外SST需求同步紧张
- 现在只是预热，不要追；下半年才是真正的发酵窗口
- 英伟达平台电源价值量大幅提升：Vera Rubin CPX版398,160美元，较GB200增长超10倍
- 电源走向800V直流架构，SiC与GaN是最大受益方向
- 功率器件逻辑类似MLCC（由电源拉动涨价），但MLCC逻辑更强
- 核心标的：扬杰科技（SiC）、金盘科技、伊戈尔、江海股份（电容）
- GaN：新洁能（A股）、英诺赛科（港股，入英伟达链）；SiC：扬杰科技

### Framework 更新

- 未更新。本次属于产业链专题细化和单日操作建议，已有"不追一致、看时间节点、发酵日不追"框架可覆盖。

### 总纲更新

- 未更新。原因是本次为产业链专题梳理和单日操作提示，尚未满足总纲级稳定框架更新条件。

---

## 2026-05-27 | qing-learning ingest | 5月27日午盘-今天不能抄底，注意外盘风险

### 学习内容

- 处理 `sources/raw/财经/午盘：26-05-27：今天不能抄底，注意外盘风险.md`

### 抽取 Claims

| ID | 类型 | 主题 | 状态 |
|----|------|------|------|
| claim-20260527-004-a | operation | 主动规避而非等待，先把弹药留出来 | active |
| claim-20260527-004-b | macro | 美股四个极端信号同时出现 | active |
| claim-20260527-004-c | technical-signal | 比特币"弹药转移"嫌疑 | active |
| claim-20260527-004-d | macro | 美伊协议市场预期过高 | active |
| claim-20260527-004-e | macro | 债市从通胀恐慌切换到衰退恐慌 | active |
| claim-20260527-004-f | market-cycle | A股三等阶段缺少进攻条件 | active |
| claim-20260527-004-g | macro | 外盘AI软着陆叙事建立在三重脆弱假设上 | active |
| claim-20260527-004-h | risk | 仓位拥挤+龙头钝化+叙事讲完=踩踏风险 | active |
| claim-20260527-004-i | methodology | 恐慌型通胀vs繁荣型通胀 | active |

### 矛盾链接更新

| Claim A | 关系 | Claim B | 类型 |
|---------|------|---------|------|
| claim-20260527-001-d（等缩量或突破、等情绪回暖、等利好落地） | superseded by | claim-20260527-004-a（主动规避而非等待） | cycle-shift / 操作上修 |

说明：早盘claim-20260527-001-d提出"等缩量等情绪回暖"的观望策略；午盘claim-20260527-004-a进一步上修为"主动规避、把弹药留出来"的降仓策略。不是逻辑冲突，而是风险信号累积后的操作上修。

### 更新 Wiki

- 更新 `每日复盘/2026-05-27.md` — 新增午盘"今天不能抄底，注意外盘风险"完整梳理

### 核心学习

- 美股四个极端信号同时出现：股市与VIX同涨、消费者信心低位+纳指新高、对冲基金半导体仓位历史级别、英伟达跑输半导体指数
- 比特币与美股背离下跌，可能是风险资产资金撤出的先行信号
- 美伊协议市场预期过高，三方表态均偏谨慎，一旦低于预期波动巨大
- 油价上涨是"恐慌型通胀"（供应受威胁）而非"繁荣型通胀"，债市从通胀恐慌切换到衰退恐慌
- 美联储立场右移，鸽派沃勒中性化，呈现滞胀剧本
- 外盘"AI软着陆"叙事建立在伊朗协议、油价回落、美联储转鸽三重假设上，都在边际走弱
- 最危险组合：仓位极致拥挤 + 龙头开始钝化 + 叙事开始讲完 → 历史上不需要利空触发就会踩踏
- A股自身处于"三等阶段"，缺少独立进攻条件
- 核心操作建议：不是等待更好的买点，而是先把仓位和心态调整到能承受意外的状态

### Framework 更新

- 未更新。本次内容主要是宏观风险警示和单日操作建议，已有"风控优先、不追一致、等出清"等 durable rule 可覆盖。

### 总纲更新

- 未更新。原因是本次为单日宏观风险警示和操作策略上修，尚未满足总纲级稳定框架更新条件。
...
### 新增 claims
- `claim-20260526-025.yaml`（9条）
  - a: 日线顶部结构5月14日形成，预计调整16个交易日
  - b: 5分钟级别双顶形态叠加对应约2小时调整周期
  - c: 抄底时时间和空间只需确定一个
  - d: 下跌末端微观结构：缓跌段+急跌+急跌后V起
  - e: 半导体上涨由大机构资金主导，非游资
  - f: 华为韬定律扩散半导体全产业链（EDA等补涨）
  - g: 散户仓位管理：容易赚钱时重仓，容易亏钱时控仓
  - h: 当前处于ABC下调中的B浪回调，主升未开始
  - i: 5月27日长鑫上会是半导体决战节点
...
### 总纲更新
- 本次为单日盘面案例+方法论教学，未满足总纲级沉淀条件，未更新 `博主方法论总纲.md`

### 新增 raw
- `sources/raw/财经/复盘：26-05-27：等了很久的回踩，月底切换与新技术分支.md`

### 新增 claims
- `claim-20260527-005.yaml`（9条）
  - a: 回踩到位+微盘止跌+科技补跌=新一轮情绪周期起点
  - b: 强修复共振 vs 弱修复，需2个交易日确认
  - c: 新技术分支（边缘计算/功率半导体/模拟芯片）率先走强
  - d: 超级电容：AI供电瓶颈，供给缺口显著
  - e: 端侧AI：AI中后期补涨分支，CAGR 39.6%
  - f: 纳米晶/金属软磁：AI供电从0到1爆发方向
  - g: SST固态变压器：AI供电三剑客，500-1000亿空间
  - h: 月底切换操作纪律：2个交易日确认，不追高潮
  - i: AI主线远没结束，6-7月新技术分支充裕演绎空间
...
### 总纲更新
- 未更新。本次为单日复盘+新技术分支梳理，尚未满足跨阶段验证条件。

## 2026-05-28 | qing-learning ingest | 5-27视频+5-28早盘：半导体卖出时点与新分支优先级

- 处理 raw：
  - `sources/raw/财经/视频：26-05-27：半导体卖出时点、存储穿越博弈与周期节奏.md`
  - `sources/raw/财经/早盘：26-05-28：调整周期未完，防御股剧本与半导体接力观察.md`
- 新增 claim 文件：
  - `knowledge/claims/claim-20260527-006.yaml`：科创50 120分钟双顶卖出信号、存储芯片穿越博弈仓位纪律、4258顶部共振风险、日线顶部结构调整周期、不能抄底的外盘风险与结构问题、半导体退潮非A杀、散户与主力定位、利润垫与仓位管理。
  - `knowledge/claims/claim-20260528-001.yaml`：5月27日回踩定性非破位、开盘三个锚点判断日内风格、超级电容机柜级标配、功率半导体年内第二轮涨价、缩量阶段新分支优先、海外映射Astrotech与Snowflake。
- 更新 wiki：
  - `knowledge/wiki/每日复盘/2026-05-27.md`（视频内容沉淀）
  - `knowledge/wiki/每日复盘/2026-05-28.md`（早盘内容沉淀）
  - `knowledge/wiki/市场分析/半导体产业链.md`
  - `knowledge/wiki/市场分析/AI电源与超级电容.md`
  - `knowledge/wiki/市场分析/指数分析.md`
  - `knowledge/wiki/投资方法论/交易纪律.md`
  - `knowledge/wiki/投资方法论/仓位管理.md`
  - `knowledge/wiki/投资方法论/主线判断.md`
- 核心学习：
  - 科创50 120分钟双顶是卖出半导体的明确技术信号，调整周期4~6天，计划性操作优于临时决策。
  - 博穿越必须满足三个条件：大盘无系统性风险+仓位轻（3个点以内）+第一时间介入（10点钟），涨起来再追就是不应该的。
  - 4258是多周期共振压力位，突破反而危险（压缩下半年窗口），当前回调是健康走势。
  - 不能抄底的三重条件：外盘环境配合+拉升有合力+龙头封板坚决，5月27日三个条件都不满足。
  - 大资金主导的半导体退潮不会A杀（调整15%左右），而是高位震荡边打边撤，小票涨停是掩护撤退。
  - 中长线≠躺平，必须利用利润垫动态降仓（赚20%砍半仓），持续观察而非忘掉账户。
  - 缩量阶段优先事件催化型新分支（超级电容、功率半导体），位置低、消耗资金少、催化硬。
