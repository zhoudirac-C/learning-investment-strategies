...
## 2026-06-03 | qing-learning ingest | 6-03早盘：调整第15天，上升途中调整临近尾声

- 处理 raw：`sources/raw/财经/早盘：26-06-03：调整第15天，上升途中调整临近尾声.md`
- 新增 claim 文件：
  - `knowledge/claims/claim-20260603-001.yaml`：调整第15天15度角浅调整上升途中歇脚而非反转、4033清仓/4130满仓纪律线、AI大部分分支上升途中调整存储抗跌MLCC最强、周二技术性反弹风格切换大概率延续、MLCC价值重估/光互连接力/CPO量产/光纤缺口、今日预案做T为主跟踪存储/MLCC/光互连
- 新增 wiki：
  - `knowledge/wiki/每日复盘/2026-06-03.md` — 早盘完整记录：指数判断、AI主线、风格判断、今日预案
- 更新 claims/index.md：新增 claim-20260603-001.yaml 的6条claims索引
- 更新 wiki/index.md：新增每日复盘/2026-06-03.md 索引
- 核心学习：
  - 顶部结构后第15天，上证15度角浅调整，形态上是趋势中继而非反转
  - AI多数方向回撤约20%，处于历史调整区间15%-30%的下沿附近，调整大概率临近尾声
  - 两个止跌信号叠加：周一120分钟低9 + 周二30分钟底部结构，短期企稳概率较大
  - 纪律线：收盘跌穿4033点清仓，突破4130点满仓（与昨日4032点相比，清仓线上移1点）
  - AI大部分分支定性为"上升途中调整"而非见顶，存储芯片抗跌性最好，MLCC为最强分支
  - 周二定性为技术性反弹，成交额前5%个股占比达2018年以来高点，风格切换理论上还会继续
  - 今日预案：做T为主，重点跟踪存储/MLCC/光互连，若仍下跌可不看盘防卖在最低点
- Framework 更新：未更新。本次为单日早盘策略，已有"交易纪律、仓位管理、情绪判断"框架可覆盖。
- 总纲更新：未更新。本次为单日盘面案例和短期策略，尚未满足总纲级沉淀条件。

## 2026-06-03 | qing-learning ingest | 6-03盘中动态（10:38）：外盘见顶的痛就一天，科技阴跌跟上证无关

- 处理 raw：`sources/raw/财经/动态：26-06-03-1038：外盘见顶的痛就一天，科技阴跌跟上证无关.md`
- 新增 claim 文件：
  - `knowledge/claims/claim-20260603-002.yaml`：外盘见顶的痛就一天后面都是科技阴跌、被外盘影响的科技成长股与上证没有直接关系、A股投资者不应过度担忧外盘风险对上证的冲击
- 新增 wiki：
  - `knowledge/wiki/市场分析/外盘与A股关系.md` — 外盘风险解耦：时效性、上证与科技股脱钩、历史关联、操作启示
- 更新 wiki：
  - `knowledge/wiki/每日复盘/2026-06-03.md` — 追加盘中动态（10:38）外盘风险解耦章节
- 更新 claims/index.md：新增 claim-20260603-002-a 索引
- 核心学习：
  - 外盘见顶的影响是短暂的（"痛就一天"），不是持续拖累
  - 后续科技股的调整是自身节奏（"科技阴跌"），不是外盘持续传导
  - 上证与科技成长股定价逻辑不同，不应混为一谈
  - 这与早盘"调整临近尾声"形成呼应——外盘不是主要矛盾，调整结束的判断更可靠
  - 5月27日"注意外盘风险"→6月3日"外盘风险已释放"，风险传导有明确的时间边界
- Framework 更新：未更新。本次为盘中动态回应，已有"宏观环境、风险判断"框架可覆盖。
- 总纲更新：未更新。本次为单日风险解耦判断，尚未满足总纲级沉淀条件。

## 2026-06-02 | qing-learning ingest | 6-02盘中四动态：4032做T、光纤逻辑、半导体缩量、SOFC/DSP新增量

- 处理 raw：
  - `sources/raw/财经/动态：26-06-02：盘中4032企稳，先买后卖做T.md`
  - `sources/raw/财经/动态：26-06-02：光纤最大卖点在地缘冲突而非AI.md`
  - `sources/raw/财经/动态：26-06-02：半导体AI硬件缩量反弹，MLCC已说很久.md`
  - `sources/raw/财经/动态：26-06-02：AI算力新增量-甲骨文SOFC与Marvell DSP.md`
- 新增 claim 文件：
  - `knowledge/claims/claim-20260602-002.yaml`：盘中4032点企稳确认可做先买后卖的T、光纤核心逻辑是地缘冲突（军用无人机）不是AI、半导体缩量反弹符合调整中继缩量上涨=阶段结束、MLCC已提前1-2周提示现在追涨是韭菜行为、AI数据中心瓶颈向两端延伸供电端SOFC和互联端DSP、SOFC和DSP国内多是预期博弈需等硬信号落地
- 更新 wiki：
  - `knowledge/wiki/每日复盘/2026-06-02.md` — 追加盘中动态补发章节（10:08做T策略、11:31光纤逻辑修正、11:53半导体缩量判断、14:00 SOFC/DSP产业梳理）
  - `knowledge/wiki/市场分析/光纤光缆.md` — 新增"2026-06-02：光纤核心逻辑修正——地缘冲突>AI"章节
  - `knowledge/wiki/市场分析/光通信.md` — 新增"2026-06-02：AI算力新增量——SOFC与DSP"完整章节
  - `knowledge/wiki/市场分析/半导体产业链.md` — 新增"2026-06-02：半导体缩量反弹=调整中继"章节
- 更新 claims/index.md：新增 claim-20260602-002.yaml 的6条claims索引
- 核心学习：
  - 4032点盘中得到验证，与早盘"盯住4032点"一致，可做先买后卖的日内T
  - 光纤产业链认知修正：最大卖点不是AI光通信，而是地缘冲突（军用无人机）。光纤龙头多有军工背景，与AI光通信标的不同
  - 半导体缩量反弹=调整中继，不是反转；AI硬件放量但"放不大"；关键信号是"缩量上涨"=阶段结束
  - MLCC已提前1-2周提示，现在追涨是韭菜行为——强调先知先觉、不追高的操作纪律
  - AI数据中心瓶颈从"算力"向供电端（SOFC）和互联端（DSP）延伸
  - SOFC：甲骨文2.8GW大单，A股间接逻辑（潮州三环、潍柴动力），国内仍处示范阶段
  - DSP：800G/1.6T光模块"大脑"，全球仅4家量产。确定性层：中际旭创、新易盛、天孚通信；预期层：裕太微、光迅科技、烽火通信
  - 海外确定性 vs 国内预期博弈：国内标的需等订单/流片/量产硬信号落地，不能仅凭概念买入
- Framework 更新：未更新。本次为盘中动态和产业逻辑梳理，已有"交易纪律、产业链认知"框架可覆盖。
- 总纲更新：未更新。本次为单日盘面操作和产业认知更新，尚未满足总纲级沉淀条件。

## 2026-06-01 | qing-learning ingest | 6-01复盘：指数冲高回落，大小票分化，AIPC相对占优

- 处理 raw：`sources/raw/财经/复盘：26-06-01：指数冲高回落，大小票分化，AIPC相对占优.md`
- 新增 claim 文件：
  - `knowledge/claims/claim-20260601-004.yaml`：6月1日盘面定调（冲高回落+大小票分化+高低位切换）、板块轮动与AIPC相对占优、AIPC核心标的逻辑（春秋电子/软通动力）、产业链延伸阅读（MLCC/AI Agent/AI Infra）、节奏理解与操作纪律（AI转向宽幅波动+守住破位纪律）、明日展望（泛科技左侧观察区）
- 更新 wiki：
  - `knowledge/wiki/每日复盘/2026-06-01.md` — 追加复盘章节：盘面定调、板块轮动、AIPC方向、产业链延伸、节奏思考、明日展望
  - `knowledge/wiki/市场分析/AI应用与软件.md` — 新增AIPC低位+科技双重属性分析、春秋电子/软通动力逻辑
  - `knowledge/wiki/市场分析/半导体产业链.md` — 新增MLCC产业链延伸阅读（风华高科/双星新材）
- 更新 claims/index.md：新增 claim-20260601-004.yaml 的6条claims索引
- 核心学习：
  - 6月1日核心矛盾：高低位切换与风格切换同步进行，AI科技调整而微盘股翻红，量能萎缩至明日或再少3000亿
  - AIPC兼具"低位+科技"双重属性，是今日科技内部相对占优方向，但本质上仍属轮动题材而非主升
  - 春秋电子：AIPC换机潮偏"卖铲"属性，结构件单价与精密度提升，Asetek液冷年出货70-100万台
  - 软通动力：智能体落地逻辑，天鹤AutoAgent+天枢FSim+Meraki工具链，为金盘科技开发标书智能体
  - MLCC是AI服务器第三大成本项，全球市场规模2026年257.3亿→2030年478.8亿美元；风华高科、双星新材
  - AI Agent商业化拐点：扣子3.0支持多人多Agent协作，接入Claude Code/Codex CLI；索辰科技、天娱数科
  - AI Infra软件：美股IGV单月涨21%，Snowflake/Datadog/Crowdstrike亮眼；深信服、星环科技、达梦数据等
  - 市场处于新旧势力交替的混沌轮动中，AI从单边强趋势转向宽幅波动，关键是守住破位纪律
  - 今日全A阳线但缺强共振，更像轮动反抽，大涨分支接近兑现位而非介入位
  - 明日：泛科技惯性回落后进入左侧观察区，AI应用/AIPC概率相对高，但小周期行情
- Framework 更新：未更新。本次为单日复盘，已有"交易纪律、仓位管理、情绪判断"框架可覆盖。
- 总纲更新：未更新。本次为单日盘面案例，尚未满足总纲级沉淀条件。

## 2026-06-01 | qing-learning ingest | 5-29视频：牛市多急跌，机构市回调规律与6月题材窗口

- 处理 raw：`sources/raw/财经/视频：26-05-29：牛市多急跌，机构市回调规律与6月题材窗口.md`
- 新增 claim 文件：
  - `knowledge/claims/claim-20260529-005.yaml`：机构市回调幅度规律、半导体双顶卖点判断、半导体设备国产化远期预期、软件/AIPC 6月题材窗口、强势板块尾盘套利法、汇率风险与出口型企业筛选、算力租赁与液冷现状、6月市场定位与磨底时间
- 更新 wiki：
  - `knowledge/wiki/每日复盘/2026-05-29.md` — 新增视频复盘章节：机构市回调规律、各方向策略、半导体卖点、软件/AIPC窗口、尾盘套利法、汇率风险、算力租赁、6月定位
  - `knowledge/wiki/市场分析/端侧AI与AIPC.md` — 新增6月催化时间线（台北电脑展、AIPC发布会、苹果开发者大会等）
  - `knowledge/wiki/市场分析/半导体产业链.md` — 新增机构市回调规律与半导体卖点判断
  - `knowledge/wiki/市场分析/Token算力.md` — 新增算力租赁与液冷更新
  - `knowledge/wiki/投资方法论/交易纪律.md` — 新增"强势板块尾盘套利法"完整章节
- 更新 claims/index.md：新增 claim-20260529-005.yaml 的8条claims索引
- 核心学习：
  - 机构市回调规律：指数回调20%时个股回调36-40%是正常幅度，牛市多急跌，长期看好方向回调30-40%非常正常
  - 半导体短期卖点：指数到6200左右卖，做日线双顶；七八月再看，有业绩的才能走出来
  - 半导体远期逻辑：上海微电子/新凯来最迟2027年IPO，光刻机产业链标的届时买不到
  - 软件/AIPC 6月窗口：必然没业绩但没法证伪，适合炒概念；七八月炒业绩时就没法炒了
  - 强势板块尾盘套利法：板块发酵确认后，20cm/30cm标的尾盘低吸，第二天高开出，适用于大多数启动时间节点
  - 汇率风险：人民币强势导致出口型企业汇兑损失，需筛选有无涨价能力和外汇套保
  - 算力租赁：D300机器从600多万涨到800万，二季度业绩看好；液冷整体还没到，继续等
- Framework 更新：未更新。本次为视频复盘，技术教学内容（尾盘套利法）已进交易纪律，市场判断具有短期时效性。
- 总纲更新：未更新。机构市回调规律已作为方法论记录，待更多市场阶段验证后再考虑纳入总纲。

## 2026-06-01 | qing-learning ingest | 6-01午盘：缩量修复，机器人与PCB反包观察

- 处理 raw：`sources/raw/财经/午盘：26-06-01：缩量修复，机器人与PCB反包观察.md`
- 新增 claim 文件：
  - `knowledge/claims/claim-20260601-003.yaml`：6月1日午盘缩量修复市场参与难度依然较大、机器人与PCB午盘有回流/反包迹象但持续性待确认
- 更新 wiki：
  - `knowledge/wiki/每日复盘/2026-06-01.md` — 追加午盘动态章节：缩量修复定性、机器人/PCB板块观察、与早盘预判呼应
- 更新 claims/index.md：新增 claim-20260601-003.yaml 的2条claims索引
- 核心学习：
  - 6月1日午盘不是强势反转，而是缩量修复——量能不足意味着资金参与度不高，修复持续性存疑
  - "还是很难做"与早盘"安分点"形成呼应，操作环境定性一致
  - 机器人回流强度一般，PCB反包力度有待确认，两者都是观察资金是否重新聚焦科技主线的信号
  - 防御板块延续调整，验证早盘补发"反向上涨票补跌"的判断
- Framework 更新：未更新。本次为单日午盘确认，已有"情绪判断、仓位管理"框架可覆盖。
- 总纲更新：未更新。本次为单日盘面案例，尚未满足总纲级沉淀条件。

## 2026-06-01 | qing-learning ingest | 6-01早盘动态UP评论：外盘历史级别泡沫

- 处理 raw：`sources/raw/财经/早盘补发：26-06-01：周五剧本延续，反向上涨票补跌.md`（UP评论补充）
- 新增 claim：
  - `knowledge/claims/claim-20260601-002.yaml` 追加 claim-20260601-002-b：外盘历史级别泡沫，这两周安分点控制仓位
- 更新 wiki：
  - `knowledge/wiki/投资方法论/仓位管理.md` — 新增"外盘历史级别泡沫与6月初仓位纪律"章节
  - `knowledge/wiki/市场分析/情绪判断.md` — 新增"外盘情绪与A股风险释放节奏"章节
- 核心学习：
  - 美股已处于"历史级别泡沫"，一旦回调会出大事，这不是普通高估而是泡沫定性
  - A股提前释放风险是好事——当前调整是在美股回调前主动释放，而非被动跟随
  - 区域分化：美股不一定大跌（可能有软着陆），但日本韩国市场泡沫风险更高、更脆弱
  - 操作建议：这两周安分点，控制仓位，不急于操作
- Framework 更新：未更新。本次为外部风险判断补充，已有"仓位管理、情绪判断"框架可覆盖。
- 总纲更新：未更新。本次为6月初短期风险提示，尚未满足总纲级沉淀条件。

## 2026-06-01 | qing-learning ingest | 6-01早盘补发：周五剧本延续，反向上涨票补跌

- 处理 raw：`sources/raw/财经/早盘补发：26-06-01：周五剧本延续，反向上涨票补跌.md`
- 新增 claim 文件：
  - `knowledge/claims/claim-20260601-002.yaml`：6月1日早盘是周五好剧本的延续，反向上涨票补跌
- 更新 wiki：
  - `knowledge/wiki/每日复盘/2026-06-01.md` — 追加盘中补发（10:37）章节：周五剧本延续、反向上涨票补跌、风险出清前不能想太多、节奏踩对收益不错踩错亏损严重
- 更新 claims/index.md：新增 claim-20260601-002.yaml 的1条claim索引
- 核心学习：
  - 6月1日早盘不是新剧本，而是周五"高低切换剧本"的延续。
  - 周五反向上涨的票（防御板块等）今天补跌，验证了早盘预判的"防御与科技跷跷板效应"。
  - "风险出清之前不能想太多"——当前仍处于风险释放阶段，不宜过早乐观。
  - 节奏重要性：踩对节奏收益不错，踩错亏损严重。
- Framework 更新：未更新。本次为盘中动态补发，已有"情绪判断、仓位管理"框架可覆盖。
- 总纲更新：未更新。本次为单日盘中确认，尚未满足总纲级沉淀条件。
