...
5. **新 claim 无 supersedes/contradicts → 跳过 discover**（2026-06-11）：discover 调 ONNX+LLM 可能超时 120s+。如果新 claim 的 supersedes/contradicts 都是空列表，直接跑 migrate。不要等 discover 超时。
