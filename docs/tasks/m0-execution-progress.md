...
- **进度**：T1–T8 ✅ 完成；T9–T15 未开始；最终 code review 未做
...
| T8 | mainline/rotation/macro 三框架改写 | ✅ | patterns[1-3] 过校验 |
| T9 | sentiment/technical/earnings 三框架改写 | ⬜ 下一个 | patterns[4-6] 过校验 + commit |
